...
public class ColorUtil {
    ...
    /* ***
     * Constructeur de la classe ColorUtil, utilisable uniquement par la classe elle-meme
     */
    private ColorUtil() {};

    /* ***
     * enum Color interne a la classe ColorUtil
     */
    public enum Color {
        RESET("\u001B[0m"),
        BLACK("\u001B[30m"),
    ...
    /* ***
     * Methodes de la classe ColorUtil
     */
