...
public class EmpruntAddServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			membres = mService.getListMembreEmpruntPossible();
		...
		request.setAttribute("membresDispo", membres);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		EmpruntService eService=EmpruntServiceImpl.getInstance();
		String inputIdLivre = request.getParameter("idLivre");
		String inputIdMembre = request.getParameter("idMembre");
		try {
			LocalDate dateEmprunt=LocalDate.now();
			eService.create(Integer.parseInt(inputIdLivre), Integer.parseInt(inputIdMembre),dateEmprunt);
		} catch (ServiceException e) {
			System.out.println(e.getMessage());
			e.printStackTrace();
		}		
